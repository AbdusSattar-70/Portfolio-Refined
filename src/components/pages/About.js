...
import {
  FaFacebookF, FaLinkedinIn, FaCircle, FaAngellist, FaGithub,
...
const SocialMediaIcon = ({ href, icon, label }) => (
  <Tippy content={`Say Hello On ${label}`}>
    <Nav.Link href={href} target="_blank" aria-label={`Visit my ${label} profile`}>
      {icon}
    </Nav.Link>
  </Tippy>
);
              ...
              <Col className="d-flex justify-content-center align-items-center">
                <div className="position-relative">
                  ...
                  <div className="social-media-overlay">
                    <SocialMediaIcon href="https://web.facebook.com/abdus.sattar.70/" icon={<FaFacebookF className="iconSize" />} label="Facebook" />
                    <SocialMediaIcon href="https://www.linkedin.com/in/abdus-sattar70/" icon={<FaLinkedinIn className="iconSize" />} label="LinkedIn" />
                    <SocialMediaIcon href="https://wellfound.com/u/abdus-sattar70" icon={<FaAngellist className="iconSize" />} label="Wellfound" />
                    <SocialMediaIcon href="https://github.com/AbdusSattar-70/" icon={<FaGithub className="iconSize" />} label="GitHub" />
                  </div>
                </div>
              </Col>
            </div>
          ...
          <Col className="mx-0 px-0">
            <div className="code-block">
              <div className="scrollable boxshadow">
                ...
                <p>
                  ■ Enhance code quality by providing actionable
                  recommendations resulting in a
                  70% reduction in code-related issues.
                </p>
                <p>
                  ■ Evaluate code clarity, style,
                  and best practices on project Pull Requests,
                ...
                <p>
                  ...
                  program, resulting in a notable 95%
                  increase in their program completion rate.
                </p>
                <p>
                  <strong>
                ...
                <p>
                  ...
                  relationships, technical expertise,
                  and consistently working without a weekly
                  day off.
                </p>
              </div>
            </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td
                        ...
                        style={{ backgroundColor: '#0a4275', color: 'white' }}
                      >
                        <h5>Soft Skills</h5>
                      </td>
                    </tr>
